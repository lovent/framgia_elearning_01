            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">Vương Minh Thái</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="/admin"><i class="fa fa-dashboard"></i> <span>Bảng Điều Khiển</span></a>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('student.index')}}"><i class="fa fa-circle-o"></i>Danh sách học sinh đang hoạt động</a></li>
                        <li><a href=""><i class="fa fa-circle-o"></i>Danh sách học sinh bị cấm</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('booking.index')}}"><i class="fa fa-circle-o"></i> Đã xác nhận </a></li>
                        <li><a href=""><i class="fa fa-circle-o"></i> Đang chờ duyệt</a></li>
                    </ul>
                </li>

            ...
            <div class="col-md-12 col-md-offset-0">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                            <h3 class="panel-title">Thêm trường mới</h3>
                    </div>

                    <div class="panel-body">                                
                        <div class="table-container">
                            <form method="POST" action="{{route('adminschool.store')}}"  role="form">
                            {{ csrf_field() }}
                                <div>
                                    <div class="form-group">
                                        <p>Tên trường *</p>
                                        <input type="text" name="school_name" required minlength="6" class="form-control input-sm" placeholder="Tên trường">
                                    </div>
                                </div>

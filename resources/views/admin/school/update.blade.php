            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">                                
                    <div class="table-container">
                        <form method="POST" action="{{route('adminschool.update', $school->id)}}" role="form"> {{ method_field('PUT') }} {!! csrf_field() !!} 
                            <div>
                                <div class="form-group">
                                    <p>Tên trường</p>
                                    <input type="text" name="school_name" required minlength="6" class="form-control input-sm" placeholder="Tên trường" value="{{$school->school_name}}">
                                </div>
                            </div>
                            <div>
                                <div class="form-group">
